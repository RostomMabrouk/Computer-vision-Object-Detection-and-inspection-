...
from logwriter import ColoredLogger
import cv2
from pynput import keyboard
from entrygate import op_main
import os
import json
...
def main():
    while True:
        ...
        for f in allfiles1:
            ...
            tray = indices[3]
            Card = indices[4]
            file_index = "5"# indices[5]
            print("processing: ", os.path.join(path_data, base))
            pill_anal = op_main(base, path_data, path_text, path_model, commonfolder, output, SP_CLBT_C1, SP_CLBB_C1, SP_CLBT_C2,
...
if __name__ == '__main__':
    ...
    LOGGER = ColoredLogger("Analysis", os.path.join(path_data, output, "outputs.txt"))
